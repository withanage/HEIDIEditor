...
var ClusterConfiguration = require("./configurations/cluster");
...
LensImporter.Prototype = function() {
  ...
  this.document = function(state, xmlDoc) {
    ...
    } else if (publisherName === 'Cluster of Excellence "Asia and Europe in a Global Context: Shifting Asymmetries and Cultural Flows"') {
      state.config = new ClusterConfiguration();
    } else {
