...
ClusterConfiguration.Prototype = function() {
  ...
  this.enhanceCover = function(state, node, element) {
    ...
    node.breadcrumbs = [
      { name: "cluster", url: "http://elife.elifesciences.org/", image: "http://lens.elifesciences.org/lens-elife/styles/elife.png" },
  ...
  this.extractPublicationInfo = function(converter, state, article) {
    ...
    // Extract research coverage
    // ------------
    //

    // <kwd-group kwd-group-type="research-coverage">
    // <title>Research coverage</title>
    // <kwd>Japan</kwd>
    // <kwd></kwd>
    // <kwd></kwd>
    // <kwd></kwd>
    // </kwd-group>
    var coverage = articleMeta.querySelectorAll("kwd-group[kwd-group-type=research-coverage] kwd");
    ...
    var pubInfoNode = {
      ...
      "research_coverage": _.pluck(coverage, "textContent"),
...
ClusterConfiguration.Prototype.prototype = DefaultConfiguration.prototype;
ClusterConfiguration.prototype = new ClusterConfiguration.Prototype();
ClusterConfiguration.prototype.constructor = ClusterConfiguration;
